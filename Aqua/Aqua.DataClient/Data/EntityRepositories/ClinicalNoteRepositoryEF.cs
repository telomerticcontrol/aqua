...
namespace Infragistics.Guidance.Aqua.DataClient.Data.EntityRepositories
{
	...
	public class ClinicalNoteRepositoryEF : BaseRepository<ClinicalNote, EF.Admittance>
	{

		public ClinicalNoteRepositoryEF()
		{
		...
		protected override IQueryable<EF.Admittance> GetCollectionQuery(CommandCriteria criteria)
		{
			...
			return this.dataContext.DataSource.Admittance.Include("ClinicalNotes").Where(d => d.ID == admittanceId);
		}
