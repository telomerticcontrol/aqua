...
namespace Infragistics.Guidance.Aqua.DataClient.Data.EntityRepositories
{
	...
	public class VitalRepositoryEF : BaseRepository<Vital, EF.Admittance>
	{

		public VitalRepositoryEF()
		{
		...
		protected override IQueryable<EF.Admittance> GetCollectionQuery(CommandCriteria criteria)
		{
			...
			return this.dataContext.DataSource.Admittance.Include("Vitals.VitalSignType").Where(d => d.ID == admittanceId);
		}
		...
		public override IEnumerable<Vital> SelectCollection(CommandCriteria criteria)
		{
			...
			if (admittance != null)
			{
				result = new VitalMapperEF().MapCollection(admittance.Vitals);
			}
